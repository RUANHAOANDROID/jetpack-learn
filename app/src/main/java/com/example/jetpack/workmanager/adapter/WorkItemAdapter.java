...
import com.example.jetpack.workmanager.WorksFragment.OnListFragmentInteractionListener;
...
public class WorkItemAdapter extends RecyclerView.Adapter<WorkItemAdapter.ViewHolder> {
    ...
    public WorkItemAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
